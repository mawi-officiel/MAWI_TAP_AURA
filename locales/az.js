...
const az = {
  ...
  "enableShortcutsText": "عرض الاختصارات المحفوظة",
  ...
  "adaptiveIconInfoText": "ستكون أيقونات الاختصارات أصغر",
  "ai_tools_button": "أدوات الذكاء الاصطناعي",
  "enable_ai_tools": "عرض اختصارات أدوات الذكاء الاصطناعي",
  "googleAppsMenuText": "تطبيقات جوجل",
  "googleAppsMenuInfo": "عرض اختصارات تطبيقات جوجل",
  // Digital Clock
  "digitalclocktittle": "الساعة الرقمية",
  "digitalclockinfo": "التبديل إلى الساعة الرقمية",
  "timeformattittle": "صيغة 12 ساعة",
  "timeformatinfo": "استخدام صيغة 12 ساعة",
  "greetingtittle": "التحية",
  "greetinginfo": "عرض التحية أسفل النص المخصص",
  // Misc
  ...
  "ProxyText": "وكيل CORS الافتراضي",
  "ProxySubtext": "أضف وكيل CORS الخاص بك",
  "HostproxyButton": "استضف وكيلك الخاص",
  "saveproxy": "حفظ",
  // Location
  "UserLocText": "أدخل موقعك",
  "UserLocSubtext": "إذا كان موقع الطقس غير صحيح",
  "userLoc": "مدينتك أو إحداثياتك (خط العرض، خط الطول)",
  "InputOptionsButton": "خيارات الإدخال",
  "saveLoc": "حفظ",
  // Weather
  ...
  "listenPlaceholder": "جاري الاستماع...",
