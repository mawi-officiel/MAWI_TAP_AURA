...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const PLACEHOLDER_SHORTCUT_URL = "https://github.com/mawi-officiel/MAWI_TAP_AURA";
    ...
    */
    function applyShortcut(shortcut) {
        ...
        if (!isValidUrl(url)) {
            ...
            url = "https://github.com/mawi-officiel/MAWI_TAP_AURA/docs/PageNotFound.html";
        }
    ...
    */
    function getFallbackFavicon(urlString) {
        ...
        } else if (urlString === "https://github.com/mawi-officiel/MAWI_TAP_AURA/docs/PageNotFound.html") {
